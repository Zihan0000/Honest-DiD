...
saveRDS(example_sdrm, file = "example_sdrm_avg.rds")
...
saveRDS(merged_SDRM, file = "C:/Users/22133/Desktop/master thesis/simulation/SDRM_avg/merged_SDRM_avg.rds")
...
plot = ggplot(merged_SDRM %>% filter(Mbar == 1), 
  ...
  ggtitle(latex2exp::TeX("$\\Delta^{SDRM}(\\bar{M})$, $\\theta = \\bar{\\tau}$")) +
  labs(x = latex2exp::TeX("$\\delta_{-1}$"), y = "Excess length ratio", 
       colour = "", shape = "", linetype = "")
plot
ggsave(plot, 
       file = here("C:/Users/22133/Desktop/master thesis/simulation/SDRM_avg/Figures/Figure_sdrm_avg.png"), 
