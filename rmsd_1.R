...
#ratio
merged_SDRM<- merge(example_sdrm_1, optEL_df_results, by = "pulse_multiplier", all.x = TRUE)
...
plot
ggsave(plot, 
       file = here("C:/Users/22133/Desktop/master thesis/simulation/SDRM_avg/Figures/Figure_sdrm_1_notag.png"), 
